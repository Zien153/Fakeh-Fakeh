...
`;
      ...
      if (isAiOutage) {
        ...
        return res.json({
          success: true,
          notice: "تم بناء السيرة الذاتية ورسالة التغطية بنجاح وفق معايير ATS الصارمة عبر المعالج الذكي الاحتياطي نظراً لقيود الـ API الحالية.",
          ...fallbackResult,
        });
      }
...
الشروط:
1. ابدأ بفعل قيادي قوي جداً (مثل: قاد، طوّر، حقق، خفّض، صمم، ��دار).
